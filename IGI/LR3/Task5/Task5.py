...
def input_func():
    ...
    print(f"Sum of elements located between the first and second zero elements : {next(sum_between_positive(float_list), 0)}")
...
def sum_between_positive(float_list):
    '''This function multiplies all elements between the passed indies'''
